...
public:
    ...
    Genetic_algorithm(float (*funct)(vector<float> &), float l, float u); /// Initialize genetic algorithm to run for a certain function
...
private:
    ...
    float elitism_rate = 0.3; ///Elitism rate
    int elitism; /// Elitism
